...
public class Mat2Img2backup implements VectorDataImageGenerator {
	...
	public Mat2Img2backup(JPanel displayJPanel) {
		this.displayJPanel=displayJPanel;

	}

	public Mat2Img2backup(JPanel displayJPanel, Mat mat) {
		this.displayJPanel=displayJPanel;
		getSpace(mat);
	}
